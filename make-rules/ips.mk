...
PKG_OPTIONS +=		$(PKG_MACROS:%=-D %) \
					-D COMPONENT_SUMMARY="$(COMPONENT_SUMMARY)" \
					-D COMPONENT_CLASSIFICATION="org.opensolaris.category.2008:$(COMPONENT_CLASSIFICATION)" \
					-D COMPONENT_DESCRIPTION="$(COMPONENT_DESCRIPTION)" \
					-D COMPONENT_LICENSE="$(COMPONENT_LICENSE)"
